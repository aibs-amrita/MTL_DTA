...
def main():
    ...
    dirpath   = os.path.join(data_path,"models/k-d", timestamp)
...
class pl_class(DeepDTA):
    ...
    def training_step(self, batch, batch_idx):
        ...
        avg_loss = (kiba_loss + davis_loss)/2
        avg_ci   = (kiba_ci + davis_ci)/2
...
class data_class(pl.LightningModule):
    ...
    def train_dataloader(self):
        ...
        loaders = {"kiba": kiba_train_loader, "davis": davis_train_loader}
    ...
    def test_dataloader(self):
        ...
        loaders = {"kiba": kiba_test_loader, "davis": davis_test_loader}
