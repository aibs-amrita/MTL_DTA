...
def main():
    ...
    dirpath   = os.path.join(data_path,"models/k-m", timestamp)
...
class pl_class(DeepDTA):
    ...
    def training_step(self, batch, batch_idx):
        ...
        avg_loss = (kiba_loss + metz_loss)/2
        avg_ci   = (kiba_ci + metz_ci)/2
...
class data_class(pl.LightningModule):
    ...
    def train_dataloader(self):
        ...
        loaders = {"kiba": kiba_train_loader, "metz": metz_train_loader}
    ...
    def test_dataloader(self):
        ...
        loaders = {"kiba": kiba_test_loader, "metz": metz_test_loader}
